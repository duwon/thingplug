...
MQTTClient client;
    ...
    char deviceId[]	    = "duwonet_airfury";
    char devicePw[] 	= "123456";
    //char container[]	= "temperature";
    char targetDeviceId[] = "duwonet_190724lab";
    char targetContainer[] = "temperature";
    char notificationName[] = "Noti_1";

    strcpy(passCode, "RC00000000000000386176");
    strcpy(strExt, "ND00000000000000007438");
    strcpy(strDkey, "d3Q0by9XVGJmZlZRY1dhNVhqOWk0eHlnQmx3eVpYYTJ4K3Nrai91MEx1MlFUTmhlSGdNbitFUkIvd3dHV0crNg==");
