...
MQTTClient client;
    ...
    char deviceId[]	    = "duwonet_plug";
    char devicePw[] 	= "123456";
    //char container[]	= "temperature";
    char targetDeviceId[] = "duwonet_190724lab";
    char targetContainer[] = "temperature";
    char notificationName[] = "Noti_2";

    strcpy(passCode, "RC00000000000000386174");
    strcpy(strExt, "ND00000000000000007436");
    strcpy(strDkey, "REpibXZpVS85UkZvMWhLT0JRbjdSRi82NW9YbzBhd3REcW02aGVyT2xEOFJTK05sWVBxckVzK2tCeXVpWDdpSw==");
